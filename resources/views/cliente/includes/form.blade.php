...
<div class="row">
    ...
    <div class="dinamic-form">
        <div class="form-group col-md-6">
            ...
            {!! Form::text('rg', old('rg'), ['class' => 'form-control', 'required','placeholder'=>'Ex: 012345678910-0', 'size'=>'13']) !!}
        </div>
        <div class="form-group col-md-3">
            {!! Form::label('cpf', 'CPF*', ['class' => 'control-label']) !!}
            {!! Form::text('cpf', old('cpf'), ['class' => 'form-control', 'required','placeholder'=>'Ex: 123.456.789-10', 'size'=>'11']) !!}
        </div>
    </div>
</div>
